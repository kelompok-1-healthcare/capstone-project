        ...
        <div class="container mx-auto max-w-screen-xl p-4">
            ...
            <div class="bg-secondary p-10 rounded-lg shadow-lg">
                <form class="space-y-8">
                    <!-- Pertanyaan 1 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Bagaimana Anda menilai kualitas tidur Anda dalam sebulan terakhir?</h5>
                        ...
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="quality-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 2 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Berapa lama biasanya Anda butuh waktu untuk tertidur pada malam hari?</h5>
                        ...
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="sleep-time-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 3 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Berapa lama biasanya Anda tidur pada malam hari?</h5>
                        ...
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="sleep-duration-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 4 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Seberapa sering Anda mengalami gangguan tidur seperti terbangun di malam hari?</h5>
                        ...
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="sleep-disturbance-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 5 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Berapa banyak waktu yang Anda habiskan di tempat tidur dibandingkan dengan waktu tidur sebenarnya?</h5>
                        ...
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="bed-time-ratio-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 6 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Seberapa sering Anda menggunakan obat tidur untuk membantu tidur?</h5>
                        <p class="mb-4">(1: ≥ 3 kali per minggu, 10: Tidak pernah)</p>
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="sleep-medication-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>
                    ...
                    <!-- Pertanyaan 7 -->
                    <div>
                        <h5 class="text-lg font-bold mb-2">Seberapa sering Anda merasa kesulitan untuk tetap terjaga atau mengalami kantuk pada siang hari?</h5>
                        <p class="mb-4">(1: ≥ 3 kali per minggu, 10: Tidak pernah)</p>
                        <div class="flex justify-start space-x-10">
                            @for($i = 1; $i <= 10; $i++)
                                <div class="flex items-center">
                                    ...
                                    <label for="daytime-sleepiness-{{ $i }}" class="ml-2 text-sm font-medium text-gray-900">{{ $i }}</label>
                                </div>
                            @endfor
                        </div>
                    </div>

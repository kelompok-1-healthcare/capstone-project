  ...
  <nav id="navbar" class="fixed top-0 w-full z-10">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4 bg-transparent transition-all duration-500 border-b border-transparent dark:bg-gray-900">
      <a class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src={{asset('assets/logo.svg')}} class="h-8" />
      </a>
      <div class="flex items-center space-x-6 rtl:space-x-reverse">
        <div class="relative font-medium rounded-full text-sm px-1 py-1 text-center bg-primary flex items-center">
          <img src={{asset('assets/girl.svg')}} class="w-8 h-8 rounded-full border-2 border-white" alt="Profile Picture">

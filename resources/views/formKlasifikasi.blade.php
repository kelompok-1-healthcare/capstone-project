    ...
    <section class="bg-white flex items-center justify-center mt-16 md:mt-20 pt-4 mt:pt-16">
        <div class="container mx-auto max-w-screen-xl p-4">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-primary mb-16 max-w-3xl">Temukan apakah Anda mengalami gangguan tidur dan pelajari cara mengatasinya dengan solusi yang tepat dan efektif. Mari mulai perjalanan Anda menuju tidur yang lebih baik dan hidup yang lebih sehat!</p>
            </div>
            <div class="bg-secondary p-4 rounded-lg shadow-lg">
                <form class="flex flex-wrap justify-center mt-6 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-4 mb-4">
                        ...
                        <select id="occupation" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

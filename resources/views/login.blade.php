            ...
            <div class="max-w-3xl mx-auto rounded-lg shadow-md overflow-hidden">
                <div class="flex flex-wrap md:flex-nowrap">
                    <div class="left w-full md:w-1/2 bg-primary flex items-center justify-center p-6">
                        <img src={{ asset('assets/robot.svg') }} alt="Robot" class="max-w-full md:max-w-xs" draggable="false">
                    </div>
                    <div class="right w-full md:w-3/4 bg-secondary p-6">
                        ...
                        <form action="/api/" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" name="password" id="password" class="block w-full mt-1 p-2 border rounded-md bg-slate-50" required>
                            </div>
                            <div class="mb-4">
                                <label for="password_confirmation" class="block text-gray-700">Konfirmasi Password</label>
                                <input type="password" name="password_confirmation" id="password_confirmation" class="block w-full mt-1 p-2 border rounded-md bg-slate-50" required>
                            </div>
                            <button
